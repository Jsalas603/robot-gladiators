...
var fightOrSkip = function () {
  ...
  if (!promptFight) { // <-- shorthand version of writting the same code as above
...
var fight = function (enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    if (isPlayerTurn) {
      // ask player if they'd like to fight or skip using fightOrSkip or skip using fightOrSkip function
      if (fightOrSkip()) {
